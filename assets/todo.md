...
- [x] **6.1** Implement "Add Task" dialog
...
- [x] **6.3** Implement drag & drop reordering
...
- [x] **7.1** Implement default scheduling algorithm
...
- [x] **7.3** Implement time formatting helpers
...
- [x] **8.1** Set up Drift database implementation
